...
def getLaneCurve(img, display=2):
    ...
    #### STEP 3
    middlePoint, imgHist = lane_detection4.getHistogram(imgWarp, display=True, minPer=0.5, region=4)
    curveAveragePoint, imgHist = lane_detection4.getHistogram(imgWarp, display=True, minPer=0.9)
